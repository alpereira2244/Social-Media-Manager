  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "border-primary bg-primary text-primary-foreground shadow-sm hover:bg-teal-800 hover:shadow",
        variant === "secondary" &&
          "border-slate-200 bg-white text-foreground shadow-sm hover:border-slate-300 hover:bg-slate-50",
        variant === "ghost" &&
